<div align="center">
<div><img src="readme_src/logo.svg" width="160px" /></div>
<h1  align="center">infinity client WebUI v1.0.0</h1>
...
2. [v1.0.1] 支持 match_text 查询
3. [v1.0.1] 支持 highlight 查询
4. [v1.0.1]个人数据库连接管理，查看连接数和手动关闭连接
5. [v1.0.2] 支持 索引管理
